                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Image.asset(home,height: 20,width: 20,
                      color: currentTab  == 0 ? whiteColor: Colors.grey,
                    ),
                  ],
                ),
              ),
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Image.asset(category,height: 20,width: 20,
                      color: currentTab  == 1 ? whiteColor: Colors.grey,
                    ),
                  ],
                ),
              ),
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Image.asset(star,height: 20,width: 20,
                      color: currentTab  == 2 ? whiteColor: Colors.grey,
                    ),
                  ],
                ),
              ),
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Image.asset(profile,height: 20,width: 20,
                      color: currentTab  == 3 ? whiteColor: Colors.grey,
                    ),
                  ],
                ),
              ),
